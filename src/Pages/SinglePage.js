              ...
              <div key={x.id}>
                <div className="detail-page-card" >
                  ...
                  <div className="detail-page-card-disc">
                    ...
                    <div className="lang flex horizontal-center vertical-center">
                      <h2>
                        Language :-
                      </h2>
                      {
                    ...
                    <div className="detail-page-download-btn flex vertical-center horizontal-center">
                      <a href={x.link} target="_blank"><i className="fa-solid fa-download"></i> Download {x.quality} ({x.size}) </a>
                    </div>
